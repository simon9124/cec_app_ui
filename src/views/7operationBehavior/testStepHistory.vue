...
export default {
        ...
        series: [
          {
            type: 'line',
            smooth: true,
            data: [1575, 1596, 1680, 1638, 1596, 1512],
            areaStyle: {
              normal: {
                color: {
                  type: 'linear', // 设置线性渐变
  ...
  watch: {
    selectTagHistoryTestStep (val) {
      this.selectTagHistoryTestStep = val;
      switch (val) {
        case 'comprehensive':
          this.dom.clear();
          ...
          this.$set(this.option, 'series', [
            {
              type: 'line',
              smooth: true,
              data: [2025, 2052, 2160, 2106, 2052, 1944],
              areaStyle: {
                normal: {
                  color: {
                    type: 'linear', // 设置线性渐变
