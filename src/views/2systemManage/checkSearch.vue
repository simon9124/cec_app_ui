          ...
          <Panel name="1"
            ...
            <Collapse slot="content"
              ...
              <Panel ref="panelIn"
                ...
                <!-- dataInner -->
                <div slot="content"
                     v-if="dataInner[i].item_group_value.length!==0"
                     style="overflowX:auto">
                  <div :style="{width:dataInner[i].item_group_value.length*80+90+'px',
                                height:'140px',fontSize:'12px'}">
                    <div :style="{display:'inline-block',width:'80px',height:'120px',
                                borderRight:'1px solid #e8eaec',borderLeft:'1px solid #e8eaec'}">
                      <div style="height:30px;border-bottom:1px solid #e8eaec;border-top:1px solid #e8eaec;text-align:center;line-height:30px">
                        项目
                      </div>
                      <div style="height:30px;border-bottom:1px solid #e8eaec;text-align:center;line-height:30px">
                        检测值
                      </div>
                      <div style="height:30px;border-bottom:1px solid #e8eaec;text-align:center;line-height:30px">
                        标准范围
                      </div>
                      <div style="height:30px;border-bottom:1px solid #e8eaec;text-align:center;line-height:26px">
                        结果
                      </div>
                    ...
                    <div v-for="(column,i) in dataInner[i].item_group_value"
                         :key="i"
                         :style="{display:'inline-block',width:'80px',height:'120px',
